...
export default function LinkToAccount() {
  ...
  return (
    <a
      ...
      className="w-[100%] sm:w-1/2 py-3 rounded-full text-center tracking-[1.5px] font-semibold font-serif bg-[#ec407a] hover:bg-sky-500 hover:shadow-[0_0_15px_#00e5ff,0_0_15px_#00e5ff,0_0_15px_#00e5ff] relative overflow-hidden z-[1] duration-500"
      onPointerMove={(event) => {
