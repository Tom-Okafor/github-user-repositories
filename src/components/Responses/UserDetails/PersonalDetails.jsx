...
export default function PersonalDetails() {
  ...
  return (
    <>
      <p className="text-center text-lg sm:text-2xl tracking-[2px] text-yellow-400 font-semibold capitalize">
        {name ? name : alternativeName}
      </p>
      <p className="max-w-[50ch] text-center leading-[1.4] text-[#aaa]">
        {bio}
      </p>
      <p className="text-md sm:text-lg text-yellow-300 tracking-[2px] font-semibold">
